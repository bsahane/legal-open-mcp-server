"""Main entry point for the Legal MCP Server."""
...
from legal_mcp_server.src.settings import validate_config as validate_config_func
from legal_mcp_server.utils.pylogger import get_python_logger, get_uvicorn_log_config
...
def main() -> None:
    ...
    Initializes logging, loads configuration, and starts the Legal MCP server.
    ...
    try:
        ...
        logger.info("Legal MCP server shutting down")
