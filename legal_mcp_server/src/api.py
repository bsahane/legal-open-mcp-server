"""This module sets up the FastAPI application for the Legal MCP server.
...
from legal_mcp_server.src.oauth.routes import register_oauth_routes
...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    try:
        if settings.ENABLE_AUTH:
            from legal_mcp_server.src.oauth.service import initialize_storage
    ...
    try:
        from legal_mcp_server.src.oauth.service import cleanup_storage
