...
class TestAPI:
    ...
    def test_health_endpoint(self):
        ...
        assert data["service"] == "legal-mcp-server"
    ...
    @patch("legal_mcp_server.src.api.settings")
    ...
    def test_app_imports(self):
        ...
        import legal_mcp_server.src.api

        assert legal_mcp_server.src.api.app is not None

    def test_server_initialization(self):
        """Test that the server is properly initialized."""
        # Arrange & Act
        from legal_mcp_server.src.api import server
    ...
    def test_transport_protocol_configuration(self, mock_settings):
        ...
        import legal_mcp_server.src.api as api_module
...
class TestRegisterEndpointRoute:
    ...
    def test_register_endpoint_returns_model_dump(self):
        ...
        with (
            patch(
                "legal_mcp_server.src.oauth.routes.get_oauth_service",
                return_value=mock_oauth_service,
            ),
            patch(
                "legal_mcp_server.src.oauth.controller.handle_register",
