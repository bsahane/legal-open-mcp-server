...
class TestPylogger:
    ...
    @patch("legal_mcp_server.utils.pylogger.structlog")
    @patch("legal_mcp_server.utils.pylogger._LOGGING_CONFIGURED", False)
    def test_get_python_logger_structlog_configuration(self, mock_structlog):
        ...
        # Act
        with patch("legal_mcp_server.utils.pylogger._LOGGING_CONFIGURED", False):
            get_python_logger()
    ...
    def test_get_python_logger_import(self):
        ...
        # Act & Assert
        try:
            import legal_mcp_server.utils.pylogger

            assert legal_mcp_server.utils.pylogger.get_python_logger is not None
        except ImportError as e:
            pytest.fail(f"Module should be importable: {e}")

    # Tests for force_reconfigure_all_loggers()
    @patch("legal_mcp_server.utils.pylogger.get_python_logger")
    ...
    @patch("legal_mcp_server.utils.pylogger._LOGGING_CONFIGURED", True)
    @patch("legal_mcp_server.utils.pylogger.get_python_logger")
    def test_force_reconfigure_resets_global_flag(self, mock_get_logger):
        ...
        import legal_mcp_server.utils.pylogger as pylogger_module
    ...
    @patch("legal_mcp_server.utils.pylogger._clear_handlers")
