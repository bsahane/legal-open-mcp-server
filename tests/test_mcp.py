...
class TestLegalMCPServer:
    """Test the LegalMCPServer class."""

    @patch("legal_mcp_server.src.mcp.force_reconfigure_all_loggers")
    @patch("legal_mcp_server.src.mcp.settings")
    @patch("legal_mcp_server.src.mcp.FastMCP")
    @patch("legal_mcp_server.src.mcp.logger")
    def test_init_success(
        self, mock_logger, mock_fastmcp, mock_settings, mock_force_reconfigure
    ):
        """Test successful initialization of LegalMCPServer."""
        # Arrange
        mock_mcp = Mock()
        ...
        mock_logger.info.assert_called_with("Legal MCP Server initialized successfully")
    ...
    def test_init_failure(
        ...
        mock_logger.error.assert_called_with(
            "Failed to initialize Legal MCP Server: Test error"
        )
