...
Prerequisites:
- Legal MCP server must be running on http://localhost:5001
...
class FastMCPClient:
    ...
    def __init__(self, server_url: str):
        ...
        # MCP configuration
        self.config = {"mcpServers": {"legal_mcp_server": {"url": f"{server_url}/mcp"}}}
    ...
    async def run_demo(self):
        ...
        print("Legal MCP Server Demo with FastMCP Client")
        print("=" * 60)
