# Contributing to Legal MCP Server
...
2. **Clone your fork:**
   ```bash
   git clone https://github.com/<your-username>/legal-mcp-server.git
   cd legal-mcp-server
   ```
...
1. **Create the tool module** in `legal_mcp_server/src/tools/`:
   ```python
   # legal_mcp_server/src/tools/your_tool.py
...
2. **Register in MCP server** (`legal_mcp_server/src/mcp.py`):
   ```python
...
4. **Update documentation** in `README.md` and `legal_mcp_server/src/tools/README.md`.
