...
1. **GitHub Security Advisories**: Use the [Report a vulnerability](https://github.com/redhat-data-and-ai/legal-mcp-server/security/advisories/new) button on the Security tab.
